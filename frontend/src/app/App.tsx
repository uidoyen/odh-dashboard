...
import InferenceServiceToastNotifications from '~/components/InferenceServiceToastNotifications';
...
import InferenceServiceNotificationsContextProvider from './InferenceServiceNotificationsContext';
...
const App: React.FC = () => {
  ...
  return (
    ...
    >
      <InferenceServiceNotificationsContextProvider>
        <Page
        ...
        >
          <ErrorBoundary>
            ...
            <InferenceServiceToastNotifications />
            <ToastNotifications />
            <TelemetrySetup />
          </ErrorBoundary>
        </Page>
